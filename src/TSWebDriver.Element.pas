...
/// <summary>
/// Obt�m o valor de um atributo HTML declarado deste elemento.
/// </summary>
...
/// valor n�o estiver definido ou se o atributo declarado n�o existir.</returns>
/// <remarks>
/// Ao contr�rio do m�todo <see cref="GetAttribute(string)"/>, este m�todo
/// retorna apenas atributos declarados na marca��o HTML do elemento. Para acessar o valor
/// de uma propriedade IDL do elemento, use o m�todo <see cref="GetAttribute(string)"/>
/// ou o m�todo <see cref="GetDomProperty(string)"/>.
/// </remarks>
...
/// <summary>
/// Obt�m o valor do atributo ou propriedade especificado para este elemento.
/// </summary>
...
/// se o valor n�o estiver definido.</returns>
/// <remarks>O m�todo <see cref="GetAttribute"/> retornar� o valor atual
/// do atributo ou propriedade, mesmo que o valor tenha sido modificado ap�s o carregamento
/// da p�gina. Observe que o valor dos seguintes atributos ser� retornado
/// mesmo se n�o houver um atributo expl�cito no elemento:
/// <list type="table">
/// <listheader>
/// <term>Nome do Atributo</term>
/// <term>Valor retornado se n�o especificado explicitamente</term>
/// <term>Tipos v�lidos de elementos</term>
/// </listheader>
/// <item>
/// <description>checked</description>
/// <description>checked</description>
/// <description>Caixa de sele��o (Check Box)</description>
/// </item>
/// <item>
/// <description>selected</description>
/// <description>selected</description>
/// <description>Op��es em elementos Select</description>
/// </item>
/// <item>
/// <description>disabled</description>
/// <description>disabled</description>
/// <description>Entrada e outros elementos de interface do usu�rio (UI)</description>
/// </item>
/// </list>
/// O m�todo verifica tanto os atributos declarados na marca��o HTML da p�gina quanto
